...
type PoolClient interface {
	CreatePool(ctx context.Context, in *structpb.Struct, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *poolClient) CreatePool(ctx context.Context, in *structpb.Struct, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type PoolServer interface {
	CreatePool(context.Context, *structpb.Struct) (*emptypb.Empty, error)
...
func (UnimplementedPoolServer) CreatePool(context.Context, *structpb.Struct) (*emptypb.Empty, error) {
...
func _Pool_CreatePool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PoolServer).CreatePool(ctx, req.(*structpb.Struct))
	}
