...
func (c *statusClient) GetCephStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetCephStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Status_GetCephStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusClient) GetCephMonDump(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CephMonDumpResponse, error) {
	...
	err := c.cc.Invoke(ctx, Status_GetCephMonDump_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusClient) GetCephOsdDump(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetCephOsdDumpResponse, error) {
	...
	err := c.cc.Invoke(ctx, Status_GetCephOsdDump_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusClient) GetCephPgDump(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetCephPgDumpResponse, error) {
	...
	err := c.cc.Invoke(ctx, Status_GetCephPgDump_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusClient) GetCephReport(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*structpb.Struct, error) {
	...
	err := c.cc.Invoke(ctx, Status_GetCephReport_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
