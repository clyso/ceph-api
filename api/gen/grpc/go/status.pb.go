...
type CephStatusHealth struct {
	...
	Checks        map[string]*structpb.Struct `protobuf:"bytes,2,rep,name=checks,proto3" json:"checks,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type CephStatusServiceMap struct {
	...
	Services      map[string]*CephStatusService `protobuf:"bytes,3,rep,name=services,proto3" json:"services,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CephStatusService struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Daemons       map[string]*structpb.Value `protobuf:"bytes,1,rep,name=daemons,proto3" json:"daemons,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type GetCephOsdDumpResponse struct {
	...
	Blocklist              map[string]*timestamppb.Timestamp     `protobuf:"bytes,29,rep,name=blocklist,proto3" json:"blocklist,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	ErasureCodeProfiles    map[string]*OsdDumpErasureCodeProfile `protobuf:"bytes,31,rep,name=erasure_code_profiles,json=erasureCodeProfiles,proto3" json:"erasure_code_profiles,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_status_proto_rawDesc = "" +
	...
	"\rGetCephReport\x12\x16.google.protobuf.Empty\x1a\x17.google.protobuf.Struct\"\x00B'Z%github.com/clyso/ceph-api/api/ceph;pbb\x06proto3"
